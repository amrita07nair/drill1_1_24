...
you risk stepping over the minimun. With the Stochastic method, there is not steps perso, but rather, at every itteration a new point is selected. This prevents the risk of stepping over the min and having to compute parameters and steps every iteration. 
The article talks about another methos that combines the speed of the Stochastic method and the precision of the standard method where random points are selected and go though a bit of the standard gradient method. 
"""
